...
INSERT INTO `address` VALUES (5, 16, '谢心宇', '13700000000', '家', 1, '2026-04-09 17:58:08', '2026-04-09 17:58:08');
...
-- Records of cart
-- ----------------------------
INSERT INTO `cart` VALUES (21, 2, 5, 3, 1, '2026-04-13 18:19:09', '2026-04-13 18:19:09');
...
CREATE TABLE `coupon`  (
  ...
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  `can_repeat` tinyint NULL DEFAULT 0 COMMENT '0只能领一次 1用完可再领',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of coupon
-- ----------------------------
INSERT INTO `coupon` VALUES (1, 5, '新人优惠', 1, 20.00, 5.00, 9.0, 100, 2, 1, 1, '2026-04-09 13:16:52', 0);
INSERT INTO `coupon` VALUES (2, 5, '老板发善心', 1, 0.00, 5.00, 9.0, 100, 3, 1, 7, '2026-04-09 17:51:58', 1);
...
INSERT INTO `order_item` VALUES (9, 3, 3, '麻辣锅底', 'https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?w=400', 8.00, 1);
INSERT INTO `order_item` VALUES (10, 3, 4, '牛肉丸', 'https://images.unsplash.com/photo-1607116667981-ff7f4ce5a04b?w=400', 6.00, 2);
INSERT INTO `order_item` VALUES (11, 4, 2, '番茄锅底', 'https://images.unsplash.com/photo-1569050467447-ce54b3bbc37d?w=400', 6.00, 1);
INSERT INTO `order_item` VALUES (12, 5, 3, '麻辣锅底', 'https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?w=400', 8.00, 1);
INSERT INTO `order_item` VALUES (13, 5, 4, '牛肉丸', 'https://images.unsplash.com/photo-1607116667981-ff7f4ce5a04b?w=400', 6.00, 1);
INSERT INTO `order_item` VALUES (14, 5, 5, '午餐肉', 'https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?w=400', 5.00, 1);
INSERT INTO `order_item` VALUES (15, 5, 6, '鸭血', 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=400', 4.00, 1);
INSERT INTO `order_item` VALUES (16, 5, 7, '嫩豆腐', 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=400', 3.00, 1);
INSERT INTO `order_item` VALUES (17, 5, 8, '土豆片', 'https://images.unsplash.com/photo-1518977676601-b53f82aba655?w=400', 2.00, 1);
INSERT INTO `order_item` VALUES (18, 5, 9, '宽粉', 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=400', 3.00, 1);
INSERT INTO `order_item` VALUES (19, 6, 9, '宽粉', 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=400', 3.00, 1);
...
INSERT INTO `orders` VALUES (3, 'fa646a579b2d4318b7ccee9e6ee8e4a5', 2, 5, 1, '张三 13900000000 学生公寓1号楼301室', 20.00, 15.00, 5, '', '2026-04-09 17:51:01', '2026-04-09 17:51:05', 0);
INSERT INTO `orders` VALUES (4, '4e4fdc87b8734b16acab2d70038b00e3', 2, 5, 1, '张三 13900000000 学生公寓1号楼301室', 6.00, 1.00, 1, '', '2026-04-09 17:52:37', '2026-04-09 17:52:37', 0);
INSERT INTO `orders` VALUES (5, '3a99db4626a648ce998694a0d1320766', 16, 5, 5, '谢心宇 13700000000 家', 31.00, 31.00, 1, '', '2026-04-09 17:58:15', '2026-04-09 17:58:15', 0);
INSERT INTO `orders` VALUES (6, '7c2c874facd64d408ffd5eca1d33622d', 2, 5, 1, '张三 13900000000 学生公寓1号楼301室', 3.00, 3.00, 5, '', '2026-04-13 18:18:48', '2026-04-13 18:18:53', 0);
...
INSERT INTO `user` VALUES (2, 'zhangsan', '25f9e794323b453885f5181f1b624d0b', '张三', '15911111111', 2, 1, 'http://localhost:8080/uploads/7b27f33930904cfd9c5f0e8d07b41be4.png', '2026-03-28 12:35:27', '2026-03-28 12:35:27', 0, NULL, NULL);
...
INSERT INTO `user` VALUES (16, '谢心宇', 'e10adc3949ba59abbe56e057f20f883e', '谢心宇', '13700000000', 2, 1, NULL, '2026-04-09 17:56:55', '2026-04-09 17:56:55', 0, '', NULL);
...
-- ----------------------------
INSERT INTO `user_coupon` VALUES (1, 2, 1, 5, 1, '2026-04-09 17:50:51', '2026-04-10 17:50:51', '2026-04-09 17:51:02', 3);
INSERT INTO `user_coupon` VALUES (2, 2, 2, 5, 1, '2026-04-09 17:52:25', '2026-04-16 17:52:25', '2026-04-09 17:52:37', 4);
INSERT INTO `user_coupon` VALUES (3, 2, 2, 5, 0, '2026-04-09 17:52:41', '2026-04-16 17:52:41', NULL, NULL);
INSERT INTO `user_coupon` VALUES (4, 16, 1, 5, 0, '2026-04-09 17:57:29', '2026-04-10 17:57:29', NULL, NULL);
INSERT INTO `user_coupon` VALUES (5, 16, 2, 5, 0, '2026-04-09 17:57:30', '2026-04-16 17:57:30', NULL, NULL);
